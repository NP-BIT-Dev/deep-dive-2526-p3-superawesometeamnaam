...
<body class="min-h-screen flex flex-col">
 ...
 <section id="hero" class="bg-white h-screen flex p-16 justify-center w-full h-full bg-contain bg-center flex-1">
        <div class="backgroundHero  flex justify-center bg-(image:dist/img/heroImg.jpg) relative w-full h-full mt-15 md:mt-40">
          <img src="dist/img/heroImg.jpg" alt="heroImg" class="absolute inset-0 w-full h-screen object-cover">

          
          <div class = "absolute inset-0 mt-50 w-full h-50 bg-gray-200/20 py-30 md:py-35 inline-block">
            <div class="relative z-10 flex flex-col items-center justify-center h-full px-8 md:px-16">
              <h2 class="text-white text-2xl md:text-5xl font-bold leading-tight drop-shadow-md max-w-2xl opacity-100">
                Rolschaatsen doe je bij<br>
                <span class="text-gray-500">ARC</span>
